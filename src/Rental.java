...
//            save.setEnabled(false);
            ...
            rs=state_R.executeQuery("SELECT `id_penyewa`, `nama_penyewa`, `alamat`, `no_hp`, `no_kto`, `Status` FROM `tb_penyewa` WHERE `id_penyewa` LIKE '%"+perental.getText()+"%'");  
                if(rs.next()){
...
//            save.setEnabled(false);
            ...
            update.setEnabled(true);
            delete.setEnabled(true);
            rs=state_R.executeQuery("SELECT `id_sepeda`, `nama_sepeda`, `merk_sepeda`, `bm_sepeda`, `harga_rental`, `Status` FROM `tb_sepeda` WHERE id_sepeda LIKE '%"+sepeda.getText()+"%'");  
                if(rs.next()){
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        try{
            rs=state_R.executeQuery("SELECT `Status` FROM `tb_sepeda` WHERE id_sepeda LIKE '%"+sepeda.getText()+"%'");  
                if(rs.next()){
...
//                    tanggal.setDate(Date.valueOf(rs.getString("tgl_rental")));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try {
            String Update_sql = "UPDATE `tb_rental` SET `id_penyewa`='"+perental.getText()+"',`id_sepeda`='"+sepeda.getText()+"',`nama_penyewa`='"+nama_penyewa.getText()+"',`nama_sepeda`='"+nama_sepeda.getText()+"',`harga_rental`='"+harga.getText()+"',`tgl_rental`='"+tanggal_rental+"',`Status`='"+statuss.getSelectedItem()+"'  WHERE id_rental = '"+rental.getText()+"'";
            state_R.executeUpdate(Update_sql);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try {
            String Delete_sql = "DELETE FROM `tb_rental` WHERE id_rental = '"+rental.getText()+"'";
            state_R.executeUpdate(Delete_sql);
